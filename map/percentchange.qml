...
<qgis styleCategories="AllStyleCategories" version="3.10.2-A Coruña" minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    <rasterrenderer opacity="1" band="1" type="singlebandpseudocolor" alphaBand="-1" classificationMax="500" classificationMin="-100">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="2" colorRampType="INTERPOLATED">
          ...
          <item value="-50" color="#7eb9d8" label="-50" alpha="255"/>
          <item value="-25" color="#afd3e5" label="-25" alpha="255"/>
          <item value="0" color="#ffffff" label="0" alpha="255"/>
          <item value="25" color="#f5bea5" label="25" alpha="255"/>
          <item value="50" color="#e66b60" label="50" alpha="255"/>
          <item value="100" color="#ca0020" label="100" alpha="255"/>
          <item value="500" color="#740818" label="500" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
